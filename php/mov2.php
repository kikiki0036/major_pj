<?php
    ...
    $hide = "on";
    $sql = mysqli_query($conn, "SELECT * FROM movie WHERE curdate()<getindate AND hide='{$hide}' ");
    $output = "";
            ...
            $output .= '<style>
                        ...
                        <a href="detail_mov.php?movie_id='.$row['movie_id'].'" class="aofmovlist" style="height: 342px;width:235px;">
                            ...
                            <div class="content">
                                ...
                                <div class="movbutton"></div></div>
                            </div>
                            <div class="mlbc-btn">
                                <a href="detail_mov.php?movie_id='.$row['movie_id'].'" class="mlbc-btn-mi" role="button" style="margin-bottom: 20px;">ดูเพิ่มเติม</a>
                            </div>   
                        </a>';
        }
    }
