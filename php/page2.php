<?php
    ...
    $hide = "on";
    $sql = mysqli_query($conn, "SELECT * FROM movie WHERE hide='{$hide}'");
    $output = "";   
// style="margin-left: -17.99999998999px";
    if(mysqli_num_rows($sql) <= 0){
        ...
        while($row = mysqli_fetch_assoc($sql)){
            ...
            $output .= '<style>
                        ...
                        <a href="detail_mov.php?movie_id='.$row['movie_id'].'" class="aofmovlist" style="margin-right:15px;height: 342px;width:235px;">
                            ...
                            <div class="mlbc-btn"  style="margin-left: -215px;margin-right: 46px;">
